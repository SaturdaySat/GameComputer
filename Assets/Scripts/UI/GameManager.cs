...
public class GameManager : MonoBehaviour
{
    ...
    void Start()
    {
        ...
        ResourceManager.GetInstance().InitManager();
    ...
    private void CreateTempComputer()
    {
        ...
        ActorHelper.GetInstance().GetHostActor().maingameLinkerComponent.ComputerCase = comCase;
    }
