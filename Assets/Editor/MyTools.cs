...
public class MyTools : EditorWindow
{
    ...
    void OnGUI()
    {
        ...
        int powerConsumption = EditorGUILayout.IntField("PowerConsum :", 0);

        if (GUILayout.Button("添加MotherBoard"))
        {
            MotherBoard motherBoard = new MotherBoard(ComputerPartType.MotherBoard, partId, partIcon, partName, partDesc, durability, powerConsumption, price, null, null, null);
